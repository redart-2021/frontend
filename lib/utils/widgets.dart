      ...
      child: Consumer<LimitOffsetPaginator<T>>(
        builder: (context, _paginator, child) {
          if (paginator.isEmpty) {
            return EmptyBody(paginator.fetchNext);
          }
...
class PaginatedGridView<T extends BaseModel> extends StatelessWidget {
  final ScrollController scrollController;
  final LimitOffsetPaginator<T> paginator;
  final ItemBuilder<T> itemBuilder;
  final int columnCount;

  PaginatedGridView(this.paginator, this.itemBuilder, [this.scrollController, this.columnCount = 3]);
          ...
          return RefreshIndicator(
            child: SingleChildScrollView(
              ...
              child: Wrap(
                ...
                children: [for (var index = 0; index < paginator.count; index++) _itemBuilder(context, index)],
              ),
            ),
            onRefresh: _refresh,
          );
